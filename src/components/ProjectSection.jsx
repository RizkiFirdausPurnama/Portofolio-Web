...
const projects = [
  ...
  },
  {
    ...
    category: 'Web Development',
    title: 'SHOP.CO',
    description: 'SHOP.CO is a responsive e-commerce web application built using a headless architecture (separate frontend and backend). Implements a complete shopping experience for users and a robust CMS for admins.',
...
function ProjectCard({ project }) {
  ...
  return (
    <div ref={ref} className="reveal col-lg-10 col-md-12 mb-5 mx-auto">
      <div
        style={{
          background: '#181818', borderRadius: '15px', overflow: 'hidden',
          transition: 'transform 0.3s ease, box-shadow 0.3s ease',
          transform: hovered ? 'translateY(-8px)' : 'translateY(0)',
          boxShadow: hovered ? '0 12px 35px rgba(0,0,0,0.4)' : 'none',
        }}
      ...
      >
        ...
        <div style={{ padding: '25px' }}>
          ...
          >
            {project.githubLabel || 'See Project'}
          </a>
        </div>
      </div>
    </div>
...
export default function ProjectSection() {
  ...
  return (
    <section id="project" style={{ padding: '80px 0', background: '#101010' }}>
